    ...
    <Box display='flex' className='testtt' h='100%' >
      <Box sx={container}>
          <Box>
            ...
            <Text sx={text}>
              En DecorAle, creamos piñatas únicas y personalizadas para celebrar tus momentos especiales.
            </Text>
            <Box>
              <Tag 
                size={{base :'sm', md:'md'}}
                >
                  Desde cumpleaños hasta bodas, ¡nosotros tenemos la piñata perfecta para ti!
              </Tag>
            </Box>
          </Box>
      </Box>
